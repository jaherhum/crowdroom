...
def upgrade() -> None:
    ...
    op.alter_column(
        'platform_connections', 'credentials_encrypted', existing_type=sa.String(), nullable=True
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    op.alter_column(
        'platform_connections', 'credentials_encrypted', existing_type=sa.String(), nullable=False
    )
