...
def get_session_service(
    ...
    history_service: QueueHistoryService = Depends(get_queue_history_service),
) -> SessionService:
...
def get_playback_service(
    ...
    queue_history_service=Depends(get_queue_history_service),
) -> PlaybackService:
    """Dependency that provides a PlaybackService instance."""
    return PlaybackService(
        session_repo=session_repo,
        queue_service=queue_service,
        queue_history_service=queue_history_service,
    )
